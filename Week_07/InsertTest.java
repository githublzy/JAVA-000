package com.zeke.homeworkdemo.week07;
...
public class InsertTest {
    ...
    static {
        try {
            // 1. 加载配置文件
            InputStream in = InsertTest.class.getClassLoader().
    ...
    public void insertBatch() {
        ...
        try {
            ...
            connection = InsertTest.getConnection();
            ...
            InsertTest.releaseDB(connection, null, null);
        }
    }
    ...
    public void insert() {
        ...
        try {
            ...
            for(int i = 0; i < 1000000; i++){
                ...
                InsertTest.releaseDB(connection, preparedStatement, null);
            }
            long end = System.currentTimeMillis();
            System.out.println("耗时"+(end - start));
        } catch (SQLException e) {
